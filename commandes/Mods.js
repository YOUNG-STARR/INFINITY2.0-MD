...
const sleep =  (ms) =>{
  ...
  infinityy({ nomCom: "tgs", categorie: "Mods" }, async (dest, zk, commandeOptions) => {
   ...
   // if (apikey === null || apikey === 'null') { repondre('Veillez vérifier votre apikey ou si vous en avez pas , veiller crée un compte sur api.lolhuman.xyz et vous en procurer une.'); return; };
    ...
    try {
      ...
      let msg = `   INFINITY-MD-stickers-dl
...
infinityy({ nomCom: "crew", categorie: "Mods" }, async (dest, zk, commandeOptions) => {
...
infinityy({ nomCom: "join", categorie: "Mods" }, async (dest, zk, commandeOptions) => {
...
infinityy({ nomCom: "jid", categorie: "Mods" }, async (dest, zk, commandeOptions) => {
...
infinityy({ nomCom: "block", categorie: "Mods" }, async (dest, zk, commandeOptions) => {
...
infinityy({ nomCom: "unblock", categorie: "Mods" }, async (dest, zk, commandeOptions) => {
...
infinityy({ nomCom: "kickall", categorie: 'Group', reaction: "📣" }, async (dest, zk, commandeOptions) => {
...
infinityy({ nomCom: "save", categorie: "Mods" }, async (dest, zk, commandeOptions) => {
...
infinityy({ nomCom: "vv", categorie: "Mods" }, async (dest, zk, commandeOptions) => {
