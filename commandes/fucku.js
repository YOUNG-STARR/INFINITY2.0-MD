    ...
    try {
      ...
      await zk.sendMessage(
        dest,
        {
          ...
          footer: `Hey ${nomAuteurMessage}! I'm INFINITY-MD, created by SIRIUS-TECH 😎`,
        },
        { quoted: ms }
      );
