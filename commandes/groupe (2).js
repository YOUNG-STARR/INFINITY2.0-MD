...
infinityy({ nomCom: "tagall", categorie: 'Group', reaction: "📣" }, async (dest, zk, commandeOptions) => {
...
infinityy({ nomCom: "link", categorie: 'Group', reaction: "🙋" }, async (dest, zk, commandeOptions) => {
...
infinityy({ nomCom: "del", categorie: 'Group',reaction:"🧹" }, async (dest, zk, commandeOptions) => {
...
infinityy({ nomCom: "info", categorie: 'Group' }, async (dest, zk, commandeOptions) => {
 ...
 infinityy({ nomCom: "antilink", categorie: 'Group', reaction: "🔗" }, async (dest, zk, commandeOptions) => {
 ...
 infinityy({ nomCom: "antibot", categorie: 'Group', reaction: "😬" }, async (dest, zk, commandeOptions) => {
...
infinityy({ nomCom: "group", categorie: 'Group' }, async (dest, zk, commandeOptions) => {
...
infinityy({ nomCom: "left", categorie: "Mods" }, async (dest, zk, commandeOptions) => {
...
infinityy({ nomCom: "gname", categorie: 'Group' }, async (dest, zk, commandeOptions) => {
...
infinityy({ nomCom: "gdesc", categorie: 'Group' }, async (dest, zk, commandeOptions) => {
...
infinityy({ nomCom: "gpp", categorie: 'Group' }, async (dest, zk, commandeOptions) => {
...
/////////////
infinityy({nomCom:"hidetag",categorie:'Group',reaction:"🎤"},async(dest,zk,commandeOptions)=>{
...
infinityy({ nomCom: "apk", reaction: "✨", categorie: "Recherche" }, async (dest, zk, commandeOptions) => {
